...
internal sealed class PaidSubscriptionOrder : SubscriptionOrder
{
    ...
    //For mongo
    internal PaidSubscriptionOrder(EntityId id, EntityId subscriptionId, CreatedAt createdAt, State state,
