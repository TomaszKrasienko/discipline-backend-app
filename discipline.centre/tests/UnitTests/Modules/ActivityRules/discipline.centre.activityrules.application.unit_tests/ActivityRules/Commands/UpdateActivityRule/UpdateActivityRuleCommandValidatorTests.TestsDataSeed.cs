...
public partial class UpdateActivityRuleCommandValidatorTests
{
    public static IEnumerable<object[]> GetValidUpdateActivityRuleCommand()
    {
        yield return
        [
            new UpdateActivityRuleCommand(UserId.New(), ActivityRuleId.New(), new ActivityRuleDetailsSpecification("test_title",
                null),"test_mode", null)
        ];
        yield return
        [
    ...
    public static IEnumerable<object[]> GetInvalidUpdateActivityRuleCommand()
    {
        ...
        yield return
        [
            new UpdateActivityRuleCommand(UserId.New(), ActivityRuleId.New(), new ActivityRuleDetailsSpecification(
